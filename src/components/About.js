    ...
    return (
        <div>
            ...
            <div className='contain' id='page'>
                ...
                <div className='docHeight hidden' id='content'>
                    <div className='d-md-flex'>
                        <div className='col col-md-6 marginx5 docHeight content-font shadow-lg d-flex flex-column justify-content-center'>
                        ...
                        <div className='col col-md-6 marginx5 content-font docHeight d-flex flex-column justify-content-center' id='desc'>
                            <div>
